...
var Qt = (t, e) => {
  for (var r in e)
    ps(t, r, { get: e[r], enumerable: true });
};
var Yg = (t, e, r, i) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let n of Gg(e))
      !Qg.call(t, n) && n !== r && ps(t, n, { get: () => e[n], enumerable: !(i = Kg(e, n)) || i.enumerable });
  return t;
};
...
function Xg() {
  ...
  function c(y) {
    var w, E = s(y), S = E[0], I = E[1], B = new r(u(y, S, I)), R = 0, U = I > 0 ? S - 4 : S, N;
    for (N = 0; N < U; N += 4)
...
function ey() {
  ...
  function d(p, l) {
    ...
    let f = B(p, l) | 0, b = o(f), A = b.write(p, l);
  ...
  s.isBuffer = function(l) {
    ...
    for (b = 0; b < l.length; ++b) {
      let k = l[b];
      if (Ye(k, Uint8Array))
        T + k.length > A.length ? (s.isBuffer(k) || (k = s.from(k)), k.copy(A, T)) : Uint8Array.prototype.set.call(A, k, T);
  ...
  s.prototype.swap16 = function() {
    ...
    if (f >>>= 0, b >>>= 0, A >>>= 0, T >>>= 0, this === l)
      return 0;
    let k = T - A, $ = b - f, se = Math.min(k, $), te = this.slice(A, T), oe = l.slice(f, b);
    for (let J = 0; J < se; ++J)
      if (te[J] !== oe[J]) {
        k = te[J], $ = oe[J];
        break;
  ...
  function K(p, l, f, b) {
    ...
    let k;
    for (k = 0; k < b; ++k) {
      let $ = parseInt(l.substr(k * 2, 2), 16);
      if (ds($))
        return k;
      p[f + k] = $;
    }
  ...
  s.prototype.writeBigUInt64LE = Mt(function(l, f = 0) {
    ...
    for (this[f] = l & 255; ++T < b && (k *= 256); )
      l < 0 && $ === 0 && this[f + T - 1] !== 0 && ($ = 1), this[f + T] = (l / k >> 0) - $ & 255;
    return f + b;
  ...
  s.prototype.writeDoubleLE = function(l, f, b) {
    ...
    if (typeof l == "number")
      ...
      let k = s.isBuffer(l) ? l : s.from(l, A), $ = k.length;
      if ($ === 0)
  ...
  cs("ERR_BUFFER_OUT_OF_BOUNDS", function(p) {
    ...
    return Number.isInteger(f) && Math.abs(f) > 2 ** 32 ? A = Tl(String(f)) : typeof f == "bigint" && (A = String(f), (f > BigInt(2) ** BigInt(32) || f < -(BigInt(2) ** BigInt(32))) && (A = Tl(A)), A += "n"), b += ` It must be ${l}. Received ${A}`, b;
  }, RangeError);
  function Tl(p) {
  ...
  function jg(p, l, f) {
    Or(l, "offset"), (p[l] === void 0 || p[l + f] === void 0) && li(l, p.length - (f + 1));
  }
  function Rl(p, l, f, b, A, T) {
    if (p > f || p < l) {
      let k = typeof l == "bigint" ? "n" : "", $;
      throw T > 3 ? l === 0 || l === BigInt(0) ? $ = `>= 0${k} and < 2${k} ** ${(T + 1) * 8}${k}` : $ = `>= -(2${k} ** ${(T + 1) * 8 - 1}${k}) and < 2 ** ${(T + 1) * 8 - 1}${k}` : $ = `>= ${l}${k} and <= ${f}${k}`, new kr.ERR_OUT_OF_RANGE("value", $, p);
    }
    jg(b, A, T);
  }
  function Or(p, l) {
    if (typeof p != "number")
      throw new kr.ERR_INVALID_ARG_TYPE(l, "number", p);
  }
  function li(p, l, f) {
    throw Math.floor(p) !== p ? (Or(p, f), new kr.ERR_OUT_OF_RANGE(f || "offset", "an integer", p)) : l < 0 ? new kr.ERR_BUFFER_OUT_OF_BOUNDS() : new kr.ERR_OUT_OF_RANGE(f || "offset", `>= ${f ? 1 : 0} and <= ${l}`, p);
  }
  ...
  function Hg(p, l) {
    ...
    for (let k = 0; k < p.length && !((l -= 2) < 0); ++k)
      f = p.charCodeAt(k), b = f >> 8, A = f % 256, T.push(A), T.push(b);
    return T;
  }
  function Cl(p) {
...
var Se = M((lI, ef) => {
  ...
  function py(t, e, r) {
    ...
    return Xt(i === r.length, `Code: ${t}; The provided arguments length (${r.length}) does not match the required ones (${i}).`), r.length === 0 ? e : ay(e, ...r);
  }
  function me(t, e, r) {
    r || (r = Error);
    class i extends r {
  ...
  me("ERR_INVALID_ARG_TYPE", (t, e, r) => {
    ...
    let n = [], o = [], s = [];
    for (let u of e)
      Xt(typeof u == "string", "All expected entries have to be of type string"), cy.includes(u) ? n.push(u.toLowerCase()) : hy.test(u) ? o.push(u) : (Xt(u !== "object", 'The value "object" should be written as "Object"'), s.push(u));
    if (o.length > 0) {
...
var fi = M((wI, ff) => {
  ...
  var qy = Ue((t, e, r = null) => {
    ...
    if (!Ss(r, "nullable", false) && t === null || !i && As(t) || typeof t != "object" && (!n || typeof t != "function"))
...
var vt = M((GI, Ls) => {
  ...
  function jf(t, e, r) {
    var i, n;
    if (arguments.length === 2 ? (r = e, e = Os) : e == null ? e = Os : mb(e, "options"), _b(r, "callback"), wb(e.signal, "options.signal"), r = xs(r), Ib(t) || Tb(t))
      return kb(t, e, r);
    if (!Rb(t))
      throw new bb("stream", ["ReadableStream", "WritableStream", "Stream"], t);
    let o = (i = e.readable) !== null && i !== void 0 ? i : ks(t), s = (n = e.writable) !== null && n !== void 0 ? n : Uf(t), a = t._writableState, u = t._readableState, c = () => {
      t.writable || g();
...
var rr = {};
Qt(rr, { EventEmitter: () => Qb, default: () => Be, defaultMaxListeners: () => Yb, init: () => Jb, listenerCount: () => Xb, on: () => Zb, once: () => ew });
var Qb;
var Yb;
var Jb;
var Xb;
...
var tn = M((LT, ac) => {
  ...
  m();
  _();
  var { ArrayIsArray: tw, ObjectSetPrototypeOf: oc } = ce(), { EventEmitter: Zi } = (ir(), X(rr));
  function en(t) {
    Zi.call(this, t);
  }
...
var Ys = we(() => {
  ...
  } }, $e = [], Oe = [], yc = typeof Uint8Array < "u" ? Uint8Array : Array, on = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", nr = 0, bc = on.length; nr < bc; ++nr)
    $e[nr] = on[nr], Oe[on.charCodeAt(nr)] = nr;
...
var di = M((Z2, Zc) => {
  ...
  Zc.exports = F;
  F.ReadableState = io;
  var { EventEmitter: Zw } = (ir(), X(rr)), { Stream: Dt, prependListener: e_ } = tn(), { Buffer: Xs } = (ye(), X(_e)), { addAbortSignal: t_ } = ci(), r_ = vt(), H = Je().debuglog("stream", (t) => {
    H = t;
  }), i_ = dc(), Dr = tr(), { getHighWaterMark: n_, getDefaultHighWaterMark: s_ } = sn(), { aggregateTwoErrors: Fc, codes: { ERR_INVALID_ARG_TYPE: o_, ERR_METHOD_NOT_IMPLEMENTED: a_, ERR_OUT_OF_RANGE: l_, ERR_STREAM_PUSH_AFTER_EOF: u_, ERR_STREAM_UNSHIFT_AFTER_END_EVENT: f_ } } = Se(), { validateObject: c_ } = fi(), lr = Xw("kPaused"), { StringDecoder: Vc } = (Uc(), X(Lc)), h_ = Js();
...
var fo = M((uR, ch) => {
  ...
  ch.exports = ie;
  ie.WritableState = yi;
  var { EventEmitter: B_ } = (ir(), X(rr)), pi = tn().Stream, { Buffer: hn } = (ye(), X(_e)), gn = tr(), { addAbortSignal: P_ } = ci(), { getHighWaterMark: k_, getDefaultHighWaterMark: O_ } = sn(), { ERR_INVALID_ARG_TYPE: x_, ERR_METHOD_NOT_IMPLEMENTED: M_, ERR_MULTIPLE_CALLBACK: oh, ERR_STREAM_CANNOT_PIPE: L_, ERR_STREAM_DESTROYED: gi, ERR_STREAM_ALREADY_FINISHED: U_, ERR_STREAM_NULL_VALUES: N_, ERR_STREAM_WRITE_AFTER_END: q_, ERR_UNKNOWN_ENCODING: ah } = Se().codes, { errorOrDestroy: jr } = gn;
  ...
  function uo(t, e, r) {
    dn(e) && ($_(t, e), e.pendingcb === 0 && (r ? (e.pendingcb++, ur.nextTick((i, n) => {
...
var Sh = M((_R, Eh) => {
  ...
  Eh.exports = function t(e, r) {
    ...
    if (typeof e == "function") {
      ...
      if (hh(n))
        return wh(fr, n, { objectMode: true, write: o, final: s, destroy: a });
    ...
    if (hh(e))
      return wh(fr, e, { objectMode: true, writable: false });
  ...
  function yn(t) {
    let e = t.readable && typeof t.readable.read != "function" ? X_.wrap(t.readable) : t.readable, r = t.writable, i = !!z_(e), n = !!K_(r), o, s, a, u, c;
    function h(d) {
      let g = u;
      u = null, g ? g(d) : d && c.destroy(d);
    }
    return c = new fr({ readableObjectMode: !!(e != null && e.readableObjectMode), writableObjectMode: !!(r != null && r.writableObjectMode), readable: i, writable: n }), n && (gh(r, (d) => {
...
var mn = M((sC, Lh) => {
  ...
  function Mh(t, e, r) {
    ...
    function y(B, R) {
      if (B && (!u || u.code === "ERR_STREAM_PREMATURE_CLOSE") && (u = B), !(!u && !R)) {
        for (; h.length; )
          h.shift()(u);
        o == null ? void 0 : o.removeEventListener("abort", a), i.abort(), R && (u || s.forEach((U) => U()), wi.nextTick(e, u, c));
      }
    }
    let w;
    for (let B = 0; B < t.length; B++) {
      ...
      if (B === 0)
        if (typeof R == "function") {
          ...
          cr(R) || wn(R) || Hr(R) ? w = R : w = kh.from(R);
      else if (typeof R == "function") {
        if (Hr(w)) {
          var E;
        ...
        if (w = R(w, { signal: n }), U) {
          ...
          w = z;
          let { destroy: de, cleanup: Gt } = xh(w, false, true);
...
var Po = M((gC, Fh) => {
  ...
  m();
  _();
  var { pipeline: R0 } = mn(), vn = nt(), { destroyer: C0 } = tr(), { isNodeStream: En, isReadable: Uh, isWritable: Nh, isWebStream: Bo, isTransformStream: hr, isWritableStream: qh, isReadableStream: Dh } = tt(), { AbortError: B0, codes: { ERR_INVALID_ARG_VALUE: jh, ERR_MISSING_ARGS: P0 } } = Se(), k0 = vt();
  Fh.exports = function(...e) {
    ...
    let c = e[0], h = R0(e, u), d = !!(Nh(c) || qh(c) || hr(c)), g = !!(Uh(h) || Dh(h) || hr(h));
...
var Qh = M((IC, xo) => {
  ...
  m();
  _();
  var Vh = globalThis.AbortController || Hi().AbortController, { codes: { ERR_INVALID_ARG_VALUE: O0, ERR_INVALID_ARG_TYPE: _i, ERR_MISSING_ARGS: x0, ERR_OUT_OF_RANGE: M0 }, AbortError: st } = Se(), { validateAbortSignal: dr, validateInteger: L0, validateObject: pr } = fi(), U0 = ce().Symbol("kWeak"), { finished: N0 } = vt(), q0 = Po(), { addAbortSignalNoValidate: D0 } = ci(), { isWritable: j0, isNodeStream: F0 } = tt(), { ArrayPrototypePush: W0, MathFloor: $0, Number: H0, NumberIsNaN: V0, Promise: Wh, PromiseReject: $h, PromisePrototypeThen: z0, Symbol: zh } = ce(), Sn = zh("kEmpty"), Hh = zh("kEof");
  function K0(t, e) {
    if (e != null && pr(e, "options"), (e == null ? void 0 : e.signal) != null && dr(e.signal, "options.signal"), F0(t) && !j0(t))
  ...
  function An(t, e) {
    ...
    return (e == null ? void 0 : e.concurrency) != null && (r = $0(e.concurrency)), L0(r, "concurrency", 1), (async function* () {
      var n, o;
      let s = new Vh(), a = this, u = [], c = s.signal, h = { signal: c }, d = () => s.abort();
      ...
      async function S() {
        try {
          for await (let R of a) {
            ...
            R !== Sn && (typeof ((I = R) === null || I === void 0 ? void 0 : I.catch) == "function" && R.catch(E), u.push(R), g && (g(), g = null), !w && u.length && u.length >= r && await new Wh((U) => {
              y = U;
            }));
          }
          u.push(Hh);
  ...
  function tm(t, e = void 0) {
    return e != null && pr(e, "options"), (e == null ? void 0 : e.signal) != null && dr(e.signal, "options.signal"), t = Gh(t), (async function* () {
      var i;
...
var bd = M((bP, yd) => {
  ...
  _();
  function Sm(t) {
    r.debug = r, r.default = r, r.coerce = u, r.disable = o, r.enable = n, r.enabled = s, r.humanize = gd(), r.destroy = c, Object.keys(t).forEach((h) => {
      r[h] = t[h];
...
var md = M((UP, _d) => {
  ...
  m();
  _();
  var Pm = fd(), { EventEmitter: km } = (ir(), X(rr)), wd = hd(), V = Wo(), D = ot()("mqtt-packet:parser"), $o = class t extends km {
    constructor() {
...
var Ko = M((hk, xd) => {
  ...
  function zm(t, e, r) {
    ...
    return e.write(j.CONNACK_HEADER), De(e, a), e.write(n.sessionPresent ? j.SESSIONPRESENT_HEADER : Dm), e.write(q.from([o])), u == null ? void 0 : u.write(), true;
  }
  function Km(t, e, r) {
  ...
  function Qm(t, e, r) {
    ...
    for (let g of a) {
      ...
      yr(e, y), B = j.SUBSCRIBE_OPTIONS_QOS[w], i === 5 && (B |= E ? j.SUBSCRIBE_OPTIONS_NL : 0, B |= S ? j.SUBSCRIBE_OPTIONS_RAP : 0, B |= I ? j.SUBSCRIBE_OPTIONS_RH[I] : 0), d = e.write(q.from([B]));
    }
    return d;
  }
  function Ym(t, e, r) {
...
var Zd = M((On) => {
  "use strict";
  var _a, _b, _l2, _l3, _c2, _p, _g, _B, _i, _y, _n, _r, _e2, _u2, _h, _a2, _s, _b2, _o, _E2, _S, _w2, __, _I, _f, _x, x_fn, _T, _A, _M, _d, _q, q_fn, _R, _P, _L, _m, m_fn, _v, v_fn, _U, U_fn, _k, k_fn, _O, O_fn, _t, t_fn, _N, N_fn, _C, C_fn, _c3;
  v();
  m();
  _();
  ...
  var _1 = (t) => !Yd.has(t), Cx = Symbol("type"), $t = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), Xd = (t) => $t(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? Xr : null : null, Xr = class extends Array {
    constructor(e) {
      super(e), this.fill(0);
    }
  }, sa = (_b = class {
    ...
    constructor(e) {
      ...
      let { max: r = 0, ttl: i, ttlResolution: n = 1, ttlAutopurge: o, updateAgeOnGet: s, updateAgeOnHas: a, allowStale: u, dispose: c, disposeAfter: h, noDisposeOnSet: d, noUpdateTTL: g, maxSize: y = 0, maxEntrySize: w = 0, sizeCalculation: E, fetchMethod: S, noDeleteOnFetchRejection: I, noDeleteOnStaleGet: B, allowStaleOnFetchRejection: R, allowStaleOnFetchAbort: U, ignoreFetchAbort: N } = e;
      if (r !== 0 && !$t(r))
      ...
      if (this.allowStale = !!u, this.noDeleteOnStaleGet = !!B, this.updateAgeOnGet = !!s, this.updateAgeOnHas = !!a, this.ttlResolution = $t(n) || n === 0 ? n : 1, this.ttlAutopurge = !!o, this.ttl = i || 0, this.ttl) {
        if (!$t(this.ttl))
    ...
    *rvalues() {
    ...
    set(e, r, i = {}) {
      ...
      if (d === void 0)
        d = __privateGet(this, _i) === 0 ? __privateGet(this, _s) : __privateGet(this, _b2).length !== 0 ? __privateGet(this, _b2).pop() : __privateGet(this, _i) === __privateGet(this, _l3) ? __privateMethod(this, _k, k_fn).call(this, false) : __privateGet(this, _i), __privateGet(this, _r)[d] = e, __privateGet(this, _e2)[d] = r, __privateGet(this, _n).set(e, d), __privateGet(this, _u2)[__privateGet(this, _s)] = d, __privateGet(this, _h)[d] = __privateGet(this, _s), __privateSet(this, _s, d), __privateWrapper(this, _i)._++, __privateGet(this, _P).call(this, d, h, u), u && (u.set = "add"), c = false;
      else {
        ...
        if (r !== g) {
          if (__privateGet(this, _I) && __privateMethod(this, _t, t_fn).call(this, g)) {
            ...
            s || (__privateGet(this, __) && ((_c4 = __privateGet(this, _p)) == null ? void 0 : _c4.call(this, g, e, "set")), __privateGet(this, _f) && ((_d2 = __privateGet(this, _o)) == null ? void 0 : _d2.push([g, e, "set"])));
          if (__privateGet(this, _R).call(this, d), __privateGet(this, _P).call(this, d, h, u), __privateGet(this, _e2)[d] = r, u) {
            u.set = "replace";
      ...
      if (n !== 0 && !__privateGet(this, _w2) && __privateMethod(this, _x, x_fn).call(this), __privateGet(this, _w2) && (c || __privateGet(this, _M).call(this, d, n, o), u && __privateGet(this, _A).call(this, u, d)), !s && __privateGet(this, _f) && __privateGet(this, _o)) {
    ...
    async fetch(e, r = {}) {
      ...
      let R = { allowStale: i, updateAgeOnGet: n, noDeleteOnStaleGet: o, ttl: s, noDisposeOnSet: a, size: u, sizeCalculation: c, noUpdateTTL: h, noDeleteOnFetchRejection: d, allowStaleOnFetchRejection: g, allowStaleOnFetchAbort: w, ignoreFetchAbort: y, status: I, signal: B }, U = __privateGet(this, _n).get(e);
      if (U === void 0) {
        I && (I.fetch = "miss");
    ...
    get(e, r = {}) {
      ...
      if (a !== void 0) {
        let u = __privateGet(this, _e2)[a], c = __privateMethod(this, _t, t_fn).call(this, u);
  ...
  }, _l3 = new WeakMap(), _c2 = new WeakMap(), _p = new WeakMap(), _g = new WeakMap(), _B = new WeakMap(), _i = new WeakMap(), _y = new WeakMap(), _n = new WeakMap(), _r = new WeakMap(), _e2 = new WeakMap(), _u2 = new WeakMap(), _h = new WeakMap(), _a2 = new WeakMap(), _s = new WeakMap(), _b2 = new WeakMap(), _o = new WeakMap(), _E2 = new WeakMap(), _S = new WeakMap(), _w2 = new WeakMap(), __ = new WeakMap(), _I = new WeakMap(), _f = new WeakMap(), _x = new WeakSet(), x_fn = function() {
    ...
    return __privateGet(this, _I) && __privateMethod(this, _t, t_fn).call(this, n) ? n.__abortController.abort(new Error("evicted")) : (__privateGet(this, __) || __privateGet(this, _f)) && (__privateGet(this, __) && ((_a3 = __privateGet(this, _p)) == null ? void 0 : _a3.call(this, n, i, "evict")), __privateGet(this, _f) && ((_b3 = __privateGet(this, _o)) == null ? void 0 : _b3.push([n, i, "evict"]))), __privateGet(this, _R).call(this, r), e && (__privateGet(this, _r)[r] = void 0, __privateGet(this, _e2)[r] = void 0, __privateGet(this, _b2).push(r)), __privateGet(this, _i) === 1 ? (__privateSet(this, _a2, __privateSet(this, _s, 0)), __privateGet(this, _b2).length = 0) : __privateSet(this, _a2, __privateGet(this, _u2)[r]), __privateGet(this, _n).delete(i), __privateWrapper(this, _i)._--, r;
    ...
    let u = { signal: s.signal, options: i, context: n }, c = (E, S = false) => {
      ...
      let R = y;
      return __privateGet(this, _e2)[r] === y && (E === void 0 ? R.__staleWhileFetching ? __privateGet(this, _e2)[r] = R.__staleWhileFetching : this.delete(e) : (i.status && (i.status.fetchUpdated = true), this.set(e, E, u.options))), E;
    ...
    return r === void 0 ? (this.set(e, w, { ...u.options, status: void 0 }), r = __privateGet(this, _n).get(e)) : __privateGet(this, _e2)[r] = w, w;
  ...
  (function(t, e) {
    ...
    var r = function(s) {
      ...
      var d = function(S) {
        ...
        var I = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, B = e.generateUniqueNumber(u);
        return u.set(B, S), h.postMessage({ id: null, method: "set", params: { delay: I, now: performance.now(), timerId: B, timerType: "timeout" } }), B;
      };
...
var ss = M((Qe) => {
  ...
  var Gv = Vt(Gu()), Fa = Vt(Nd()), Qv = Vt(Jo()), Yv = jt(), Dp = Vt(Fd()), jp = $p($d()), Jv = Vt(ot()), rs = Vt(ea()), Xv = Vt(Ip()), is = Jr(), Zv = Tp(), eE = Vt(ja()), Fp = $p(Pi()), Wa = globalThis.setImmediate || ((...t) => {
    ...
    subscribe(e, r, i) {
      ...
      if (a !== null)
        return Wa(i, new Error(`Invalid topic ${a}`)), this;
    ...
    unsubscribe(e, r, i) {
      ...
      if (n !== null)
        return Wa(i, new Error(`Invalid topic ${n}`)), this;
      if (this._checkDisconnecting(i))
        return this;
      let o = () => {
        let s = this._nextId();
...
var Jp = we(() => {
  ...
  zp = function(t, e) {
    ...
    return e.join("");
  }, zt = { version: "2.1.0", ucs2: { decode: Qp, encode: (t) => String.fromCodePoint(...t) }, decode: Kp, encode: Gp, toASCII: function(t) {
...
function cE() {
  ...
  var n = { resolve: function() {
    ...
    for (var g = a.length, y = g - d, w = h < y ? h : y, E = -1, S = 0; S <= w; ++S) {
      ...
      var I = s.charCodeAt(u + S), B = a.charCodeAt(d + S);
      if (I !== B)
        break;
      I === 47 && (E = S);
    }
...
var pg = {};
Qt(pg, { URL: () => FE, Url: () => UE, default: () => Z, fileURLToPath: () => hg, format: () => NE, parse: () => jE, pathToFileURL: () => dg, resolve: () => qE, resolveObject: () => DE });
function Fe() {
...
var gg = we(() => {
  ...
  og();
  Qa();
  Z = {}, hE = zt, gt = { isString: function(t) {
...
var nl = {};
Qt(nl, { Server: () => Me, Socket: () => Me, Stream: () => Me, _createServerHandle: () => Me, _normalizeArgs: () => Me, _setSimultaneousAccepts: () => Me, connect: () => Me, createConnection: () => Me, createServer: () => Me, default: () => eS, isIP: () => Me, isIPv4: () => Me, isIPv6: () => Me });
function Me() {
...
var _l = M((Ui) => {
  ...
  var OS = (t, e) => {
    ...
    let r, n = BS(e).browserBufferSize || 1024 * 512, o = e.browserBufferTimeout || 1e3, s = !e.objectMode, a = kS(t, e), u = h(e, E, S);
    ...
    function w(I) {
      let { data: B } = I;
      B instanceof ArrayBuffer ? B = yl.Buffer.from(B) : B = yl.Buffer.from(B, "utf8"), u.push(B);
    }
    function E(I, B, R) {
...
var kg = M((Rr) => {
  ...
  function Pg(t, e) {
    ...
    if (Bg("connecting to an MQTT broker..."), typeof t == "object" && !e && (e = t, t = ""), e = e || {}, t && typeof t == "string") {
      let a = LS.default.parse(t, true), u = {};
      if (a.port != null && (u.port = Number(a.port)), u.host = a.hostname, u.query = a.query, u.auth = a.auth, u.protocol = a.protocol, u.path = a.path, u.protocol = (r = u.protocol) === null || r === void 0 ? void 0 : r.replace(/:$/, ""), e = Object.assign(Object.assign({}, u), e), !e.protocol)
        throw new Error("Missing protocol");
    }
    if (e.unixSocket = e.unixSocket || ((i = e.protocol) === null || i === void 0 ? void 0 : i.includes("+unix")), e.unixSocket ? e.protocol = e.protocol.replace("+unix", "") : !((n = e.protocol) === null || n === void 0) && n.startsWith("ws") || delete e.path, qS(e), e.query && typeof e.query.clientId == "string" && (e.clientId = e.query.clientId), e.cert && e.key)
      if (e.protocol) {
    ...
    if (!Re[e.protocol]) {
      ...
      e.protocol = ["mqtt", "mqtts", "ws", "wss", "wx", "wxs", "ali", "alis"].filter((u, c) => a && c % 2 === 0 ? false : typeof Re[u] == "function")[0];
    }
    if (e.clean === false && !e.clientId)
      throw new Error("Missing clientId for unclean clients");
    e.protocol && (e.defaultProtocol = e.protocol);
    function o(a) {
      return e.servers && ((!a._reconnectCount || a._reconnectCount === e.servers.length) && (a._reconnectCount = 0), e.host = e.servers[a._reconnectCount].host, e.port = e.servers[a._reconnectCount].port, e.protocol = e.servers[a._reconnectCount].protocol ? e.servers[a._reconnectCount].protocol : e.defaultProtocol, e.hostname = e.host, a._reconnectCount++), Bg("calling streambuilder for", e.protocol), Re[e.protocol](a, e);
    }
    let s = new US.default(o, e);
    return s.on("error", () => {
    }), s;
  }
  function DS(t, e, r = true) {
    return new Promise((i, n) => {
      let o = Pg(t, e), s = { connect: (u) => {
        a(), i(o);
      }, end: () => {
        a(), i(o);
      }, error: (u) => {
